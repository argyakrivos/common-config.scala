...
class Slf4jReporterTests extends FunSuite with MockitoSyrup {
  ...
  test("Reports timer metrics in the MDC") {
    ...
    assert(mdc.get("p75") == "0.0")
    assert(mdc.get("p95") == "0.0")
    assert(mdc.get("p98") == "0.0")
    assert(mdc.get("p99") == "0.0")
    assert(mdc.get("p999") == "0.0")
    assert(mdc.get("meanRate") == "0.0")
    assert(mdc.get("m1") == "0.0")
    assert(mdc.get("m5") == "0.0")
    assert(mdc.get("m15") == "0.0")
